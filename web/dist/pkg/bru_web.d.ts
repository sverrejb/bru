...
export class Bru {
    ...
    online(): Promise<void>;
    static open(secret_key: Uint8Array, relay_url?: string | null, relay_token?: string | null): Promise<Bru>;
...
export interface InitOutput {
    ...
    readonly bru_open: (a: number, b: number, c: number, d: number, e: number, f: number) => number;
    ...
    readonly __wasm_bindgen_func_elem_4046: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_4106: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_3103: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_3103_2: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_3103_3: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_1489: (a: number, b: number) => void;
    readonly __wasm_bindgen_func_elem_5220: (a: number, b: number) => void;

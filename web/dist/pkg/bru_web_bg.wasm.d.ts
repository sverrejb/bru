...
export const __wasm_bindgen_func_elem_3988: (a: number, b: number, c: number, d: number) => void;
export const __wasm_bindgen_func_elem_4049: (a: number, b: number, c: number, d: number) => void;
export const __wasm_bindgen_func_elem_2399: (a: number, b: number, c: number) => void;
export const __wasm_bindgen_func_elem_2399_2: (a: number, b: number, c: number) => void;
export const __wasm_bindgen_func_elem_2399_3: (a: number, b: number, c: number) => void;
export const __wasm_bindgen_func_elem_1437: (a: number, b: number) => void;
export const __wasm_bindgen_func_elem_5130: (a: number, b: number) => void;
